...
glVertex3f(0.6 + (0.08 * cos(((theta + angle) * 3.14) / 180)),0.2 + (0.08 * sin(((theta + angle) *
3.14) / 180)),0.62);
}
glEnd();
glBegin(GL_LINE_STRIP);
...
glVertex3f(1.7 + (0.08 * cos(((theta + angle) * 3.14) / 180)), 0.2 + (0.08 * sin(((theta + angle) *
3.14) / 180)), 0.18);
}
glEnd();
glBegin(GL_LINE_STRIP);
